...
#r "../../functional-csharp-code/LaYumba.Functional.Data/bin/Debug/netstandard1.6/LaYumba.Functional.Data.dll"
...
public static void LabelTreeLocalize()
{
    // a category tree
    ...
    var res = expected == localizedTree;
}
